...
public class photomosaic extends PApplet {
...
public float aveBrightness(PImage img) {
  float result = 0;
...
public void captureAndSave(int x, int y, int w, int h){
  cap = get(x, y, w, h);
  selectInput("Select a file to process:", "saveSelected");
  println("saved!");
}
  public void settings() {  size(920,650); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "photomosaic" };
    if (passedArgs != null) {
